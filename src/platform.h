...
static inline void plan_set_gpio(struct platform_plan *plan, int pin, bool value) {
...
static inline void plan_set_pwm(struct platform_plan *plan, int pin, float value) {
