...
struct output_event_schedule_state {
  const struct output_event_config *config;   /* Reference to the configuration for the event */
...
void invalidate_scheduled_events(struct output_event_schedule_state evs[], int n_events);
