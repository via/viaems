...
struct table timing_vs_rpm_and_map __attribute__((section(".configdata"))) = {
  ...
  .data = {
    .two = {
      ...
      {8.0, 8.0, 8.0, 8.0, 10.0, 15.0, 18.0, 22.0, 28.0, 30.0, 30.0, 30.0, 30.0, 30.0, 30.0, 30.0},

      {8.0, 10.0, 10.0, 12.0, 13.0, 13.0, 18.0, 21.0, 26.0, 28.0, 28.0, 28.0, 28.0, 28.0, 28.0, 28.0},
      {8.0, 10.0, 10.0, 12.0, 13.0, 13.0, 15.0, 19.0, 23.0, 24.0, 24.0, 24.0, 24.0, 24.0, 24.0, 24.0},
