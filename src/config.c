...
struct config config __attribute__((section(".configdata"))) = {
  .num_events = 18,
  .events = {
    {.type=IGNITION_EVENT, .angle=0, .output_id=12, .inverted=0},
    {.type=IGNITION_EVENT, .angle=90, .output_id=13, .inverted=0},
    {.type=IGNITION_EVENT, .angle=180, .output_id=14, .inverted=0},
    {.type=IGNITION_EVENT, .angle=270, .output_id=15, .inverted=0},
    {.type=ADC_EVENT, .angle=270},

    {.type=IGNITION_EVENT, .angle=360, .output_id=12, .inverted=0},
    {.type=IGNITION_EVENT, .angle=450, .output_id=13, .inverted=0},
    {.type=IGNITION_EVENT, .angle=540, .output_id=14, .inverted=0},
    {.type=IGNITION_EVENT, .angle=630, .output_id=15, .inverted=0},
  ...
  .sensors = {
    ...
    [SENSOR_EGO] = {.pin=4, .source=SENSOR_ADC, .method=METHOD_LINEAR,
      .params={.range={.min=0, .max=100}}},
    [SENSOR_MAP] = {.pin=3, .source=SENSOR_ADC, .method=METHOD_LINEAR,
      .params={.range={.min=0, .max=400}},
      .fault_config={.min = 100, .max = 4000, .fault_value = 40.0}},
