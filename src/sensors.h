...
float sensor_convert_thermistor(const struct sensor_config *in, const float raw);
...
void sensor_update_freq(struct sensors *, const struct engine_position *, const struct freq_update *);
void sensor_update_adc(struct sensors *, const struct engine_position *, const struct adc_update *);
