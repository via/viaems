...
static struct console_config_node console_config_nodes[] = {
  ...
  { .name = "config.tasks.cel.lean_boost_ego",
    ...
    .get = console_get_float,
    .set = console_set_float },
  { .name = "config.tasks.closed_loop.ll_Kp",
    .val = &config.closed_loop.low_load_K_p,
    .get = console_get_float,
    .set = console_set_float },
  { .name = "config.tasks.closed_loop.ll_Ki",
    .val = &config.closed_loop.low_load_K_i,
    .get = console_get_float,
    .set = console_set_float },
  { .name = "config.tasks.closed_loop.ll_max",
    .val = &config.closed_loop.low_load_max_correction_us,
    .get = console_get_float,
    .set = console_set_float },
  ...
  { .name = "status.fueling.tipin",
    ...
    .get = console_get_float },
  { .name = "status.fueling.trim",
    .val = &calculated_values.closed_loop_correction_us,
    .get = console_get_float },
  { .name = "status.fueling.cum_error",
    .val = &calculated_values.closed_loop_cumulative_error,
    .get = console_get_float },
  { .name = "status.fueling.ego_delay",
    .val = &calculated_values.closed_loop_ego_delay,
    .get = console_get_float },
  { .name = "status.fueling.corrected_ve",
    .val = &calculated_values.closed_loop_corrected_ve,
    .get = console_get_float },
  ...
  { .name = "status.sensors.map.rate",
    .val = &config.sensors[SENSOR_MAP].derivative.value,
    .get = console_get_float },
  ...
  { .name = "status.sensors.tps",
    ...
    .get = console_get_float },
  { .name = "status.sensors.tps.rate",
    .val = &config.sensors[SENSOR_TPS].derivative.value,
    .get = console_get_float },
  ...
  { .name = "status.sensors.ego",
    ...
    .get = console_get_float },
  { .name = "status.sensors.ego.rate",
    .val = &config.sensors[SENSOR_EGO].derivative.value,
    .get = console_get_float },
...
void console_init() {
  const char *console_feed_defaults[] = {
    "status.current_time",         "status.decoder.state",
    "status.decoder.rpm",          "status.decoder.loss_reason",
    "status.decoder.rpm_variance", "status.decoder.t0_count",
    "status.decoder.t1_count",     "status.ignition.timing_advance",
    "status.fueling.pw_us",        "status.fueling.ete",
    "status.fueling.ve",           "status.fueling.lambda",
    "status.fueling.idt",          "status.fueling.tipin",
    "status.fueling.trim",         "status.fueling.cum_error",
    "status.sensors.brv",          "status.sensors.map",
    "status.sensors.aap",          "status.sensors.tps",
    "status.sensors.iat",          "status.sensors.clt",
    "status.sensors.ego",          NULL,
  };
