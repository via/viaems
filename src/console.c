...
static struct console_config_node console_config_nodes[] = {
  ...
  { .name = "config.tasks.cel.lean_boost_ego",
    ...
    .get = console_get_float,
    .set = console_set_float },
  { .name = "config.tasks.closed_loop.K_u",
    .val = &config.closed_loop.K_u,
    .get = console_get_float,
    .set = console_set_float },
  { .name = "config.tasks.closed_loop.ego_response_time",
    .val = &config.closed_loop.ego_response_time,
    .get = console_get_float,
    .set = console_set_float },
  ...
  { .name = "status.fueling.trim",
    .val = &calculated_values.closed_loop_correction,
    .get = console_get_float },
